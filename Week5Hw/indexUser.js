...
userData.forEach((num) => phoneNums.push(num.phone));

console.log(phoneNums);

//LIST OF WEBSITE AND EMAIL PAIRS
const websiteAndEmail = [];

userData.forEach((num) => websiteAndEmail.push(`${num.website} website and ${num.email} email`));
